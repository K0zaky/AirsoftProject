...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView cardImgLogin;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnRegister, @NonNull CardView cardImgLogin, @NonNull CardView cardLogin,
      @NonNull MaterialCheckBox cbRemember, @NonNull TextInputEditText etPassword,
      @NonNull TextInputEditText etUsername, @NonNull ImageView imgLogin) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.btnRegister = btnRegister;
    this.cardImgLogin = cardImgLogin;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cardImgLogin;
      CardView cardImgLogin = ViewBindings.findChildViewById(rootView, id);
      if (cardImgLogin == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnRegister,
          cardImgLogin, cardLogin, cbRemember, etPassword, etUsername, imgLogin);
    }
